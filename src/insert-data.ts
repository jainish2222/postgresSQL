...
async function createEntries() {
    ...
    const insertUserText = 'INSERT INTO users (email, password) VALUES ($1, $2) RETURNING id';  // we can use $1,$2 for preventing SQL injection
    const userValues = ['jainishkoladiya@gmail2.com', 'hashed_password_here'];
